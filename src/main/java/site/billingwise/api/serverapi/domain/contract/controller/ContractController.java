...
public class ContractController {
    ...
    public DataResponse<CreateBulkContractResultDto> createContractBulk(@RequestPart("file") MultipartFile file) {
        CreateBulkContractResultDto createBulkContractResultDto = contractService.createContractBulk(file);

        return new DataResponse<>(SuccessInfo.CONTRACT_CREATED, createBulkContractResultDto);
    }
