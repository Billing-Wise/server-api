...
class ItemServiceTest {
	...
	void getItemListSearch() {
		...
		when(SecurityUtil.getCurrentUser()).thenReturn(Optional.of(mockUser));
		given(itemRepository.findAllByNameByClientIdContainingIgnoreCase(anyString(), any(Pageable.class), anyLong()))
				.willReturn(itemPage);
		...
		verify(itemRepository).findAllByNameByClientIdContainingIgnoreCase(anyString(), any(Pageable.class), anyLong());
	}
